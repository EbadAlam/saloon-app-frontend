      ...
      <div className="container-fluid dashboard-content">
        ...
        >
          <Box display="flex" alignItems="center" gap={1.5}>
            <BackButton />
            <Typography color="#aaa" variant="h5">
              <Link to={ROUTES.adminStores}>Stores</Link> &rsaquo;{" "}
              <Link to={ROUTES.getAdminSingleStore(storeId)}>
                {storeName ?? "..."}{" "}
              </Link>
              &rsaquo; Services
            </Typography>
        ...
        {showForm && (
          ...
          >
            ...
            <FormControl fullWidth margin="normal">
              ...
              >
                {categories
                  ?.filter((cat) => cat.category.status === "active")
                  .map((cat) => (
        ...
        <TableContainer sx={{ maxWidth: 1300 }} component={Paper}>
          <Table aria-label="Services Table">
            ...
            {services && services.length > 0 ? (
              services.map((singleSer, index) => (
                <>
                  <TableBody>
                    ...
                    <TableCell align="right">{singleSer.eta}</TableCell>
                    <TableCell align="right">
                      {singleSer.currency} {singleSer.price}
                    </TableCell>
                    <TableCell align="right">
                      {singleSer.gender
                        ? singleSer.gender.charAt(0).toUpperCase() +
                          singleSer.gender.slice(1)
                        : "---"}
                    </TableCell>
                    <TableCell
                      align="right"
              ...
              <TableBody>
                <TableCell align="center">No Services</TableCell>
              </TableBody>
            )}
          </Table>
        </TableContainer>

...
function ReviewsPage() {
  ...
  (0, _react.useEffect)(() => {
    const fetchWorkersReviews = async () => {
      ...
      try {
        const {
          data
        } = await _axiosClient.default.get("/getWorkerReviews/".concat(user.id));
  ...
  return /*#__PURE__*/_react.default.createElement(_Layout.default, null, loading && /*#__PURE__*/_react.default.createElement(_Loader.default, null), /*#__PURE__*/_react.default.createElement("div", {
    ...
    variant: "h4"
  }, "Team Members")), /*#__PURE__*/_react.default.createElement(_material.TableContainer, {
    ...
    component: "th",
    scope: "row"
  }, formatDate(singleReview.reviewed_at))))) : /*#__PURE__*/_react.default.createElement(_material.TableBody, null, /*#__PURE__*/_react.default.createElement(_material.TableCell, {
    align: "center"
  }, "No Reviews"))))));
}
var _default = exports.default = ReviewsPage;
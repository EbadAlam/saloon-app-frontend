...
import { Box, Checkbox, LinearProgress, MenuItem, Select, Typography } from '@mui/material';
...
function AllReviewsPage() {
  ...
  return (
    <Box sx={{ maxWidth: '70%', margin: '0 auto' }}>
      ...
      <Box display="flex" alignItems="start" gap="50px" className='all-reviews-main' sx={{ paddingInline: '150px' }}>
        <Box className='all-reviews-reviews' sx={{ width: '60%' }}>
          <Typography variant="h4" className='mt-5'>Reviews</Typography>
          <Box display="flex" justifyContent="space-between">
            <Typography variant="h6" className='mt-3'>{filteredReviews.length} reviews</Typography>
            <Box display='flex' alignItems="center" gap="10px" sx={{ margin: '0' }}>
                  ...
                  <div className="review mt-3" key={singleReview.id}>
                    <div className="user_info">
                      <div className="user_img">
                        ...
                        {singleReview.reviewer.user_info && singleReview.reviewer.user_info.profile_image ? (
                          singleReview.reviewer.user_info?.signup_platform == "manual" ? (
                            <img
                              src={`${process.env.REACT_APP_IMG_URL}/${singleReview.reviewer.user_info.profile_image}`}
                              alt="Profile"
                            />
                      ...
                      <div className="user-name-time">
                        ...
                        <p className="time">{formatDate(singleReview.reviewed_at)}</p>
                      </div>
                    </div>
        ...
        <Box className='all-reviews-filter' sx={{ width: '40%' }}>
          <div className="rating_filter">
            <div className="rating_star">
              <StarIcon fontSize="large" style={{ color: '#333333' }} />
              <StarIcon fontSize="large" style={{ color: '#333333' }} />
              <StarIcon fontSize="large" style={{ color: '#333333' }} />
              <StarIcon fontSize="large" style={{ color: '#333333' }} />
              <StarIcon fontSize="large" style={{ color: '#333333' }} />
            ...
            <div className="avg_count">
              <Typography variant="h6">{averageRatingStore} • {storeDetails.reviews.length} reviews</Typography>
            </div>
              ...
              <Typography variant="h6">
                ...
                <Box>
                  {ratingCounts.map(({ value, count }) => {
                    ...
                    return (
                      <Box key={value} display="flex" alignItems="center" mb={1} gap={1}>
                        <Checkbox
                          size="small"

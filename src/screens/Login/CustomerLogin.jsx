...
function CustomerLoginPage() {
    ...
    const handleEmailCheck = async (e) => {
        e.preventDefault();
        setLoading(true);
        const payload = { email: email, roles: ['customer'] }
        try {
    ...
    return (
        <Box className="bt-auth">
            ...
            <div className="bt-auth__content bt-auth__content--center">
                ...
                {showForm === 'basic' && (
                    <>
                        <span className="bt-auth__eyebrow">Customers</span>
                        <h1 className="bt-auth__title">Welcome to <span>BeautyTrafic</span></h1>
                        <p className="bt-auth__subtitle">Create an account or log in to book and manage your appointments.</p>

                        <div className="bt-auth-form">
                            <Link
                                className="bt-auth-social"
                                to={`${process.env.REACT_APP_LARAVEL_BASE_URL}/auth/google/redirect?login_type=customer`}
                            >
                            ...
                            <p className="bt-auth-switch">
                                ...
                                <Link to={ROUTES.ownerLogin} className="bt-auth-switch__link">Sign in as professional</Link>
                            </p>
                        </div>
                    </>
                )}
